...
map.add_child(fgv)
map.add_child(fgp)
fg = folium.FeatureGroup(name="My Baby")
fg.add_child(folium.CircleMarker(location=[23.748296,90.409065],radius = 6, popup ="The love of my life Aqila Baby lives here",fill_color="purple",color='grey',fill = True, fill_opacity=1))
map.add_child(fg)
